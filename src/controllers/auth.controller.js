    ...
    export const signup = async (req, res) => {
        ...
        try {
            ...
            if (user) return res.status(400).json({ message: "ဖြည့်စွက်သောအီးမေးလ် ရှိပြီးဖြစ်သည်။" });
    ...
    export const login = async (req, res) => {
        ...
        try {
            ...
            if (!isPasswordCorrect) {
                return res.status(400).json({ message: "အီးမေးလ် သို့မဟုတ် လျှို့ဝှက်နံပါတ် မှားနေသည်။" });
            }
